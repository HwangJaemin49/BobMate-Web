  ...
  return (
    <div className='all'>
      ...
      >
        ...
        >
          <p style={{ fontSize: '21px' }}>식사 상황별 콘텐츠 추천 서비스</p>
          <br />
          <div
            style={{
              width: '350px',
          ...
          >
            <img
              ...
              style={{ float: 'left' }}
            />
            <p style={{ fontSize: '70px', fontFamily: 'Cafe24surround' }}>
              밥 친구
            </p>
          </div>
      ...
      >
        ...
        >
          <div
            ...
            style={{ fontFamily: 'Pretendard-Bold', fontSize: '35px' }}
          >
            영상 Best 3
          </div>
          <VideoContent accessToken={accessToken} />
          <br />
          <br />
        </div>
        <div
