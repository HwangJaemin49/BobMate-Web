...
const Content = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://43.202.23.75/api/v1/contents/top3?section=0');
        ...
        <div className='content-container' style={{margin: "0px auto", height: "350px", textAlign: "center"}} >
            <div className='first-container' style={{height:"300px"}}>
                {content && content.map((res, index) => (
                    <div className='videoTop3' style={{width:"30%", float:"left"}}>
                        ...
                        <div style={{}}>
                            <a href={res.linkUrl} target='_blank' rel="noopener noreferrer"><img src={res.imgUrl} alt="비디오 컨텐츠 Top3" style={{height:"280px", width:"200px", borderRadius: "30px"}}></img></a>
                        </div>
